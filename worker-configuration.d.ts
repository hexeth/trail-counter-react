// Generated by Wrangler by running `wrangler types` (hash: 88853fddbc162b087246e10a77bab3c7)
// Runtime types generated with workerd@1.20250409.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		TRAIL_DO: DurableObjectNamespace<import("./workers/app").TrailDO>;
		REGISTRATION_DO: DurableObjectNamespace<import("./workers/app").RegistrationDO>;
		TEMPLATE_DO: DurableObjectNamespace<import("./workers/app").TemplateDO>;
		TRAIL_MANAGER_DO: DurableObjectNamespace<import("./workers/app").TrailManagerDO>;
		AUTH_DO: DurableObjectNamespace<import("./workers/app").AuthDO>;
	}
}
